...
function pagina_impostazioni_tema_cb(){
   ...
   $pagina_impostazioni= add_theme_page(
       ...
       'impostazioni_tema', // Slug della pagina, utilizziamo __FILE__ per dare uno slug unico
...
function custom_theme_css() {
	wp_enqueue_style( 'bones_login_css', get_template_directory_uri() . '/inc/css/style.css', false );
}


add_action( 'login_enqueue_scripts', 'custom_theme_css', 10 );
